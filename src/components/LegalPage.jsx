...
const LegalPage = () => {
  ...
  useEffect(() => {
    ...
    const hash = location.hash; // <--- Use location.hash
    if (hash) {
  ...
  return (
    <div style={{ fontFamily: 'Britannic Bold' }} className="relative min-h-screen overflow-x-hidden bg-black text-white">
      {/* Glowing Grid Overlay (optional, if you want it on these pages) */}
      <div
      ...
      <div className="relative z-10">
        ...
        <section className="max-w-4xl mx-auto py-20 px-6 sm:px-8 lg:px-10 text-gray-300">

          {/* Terms of Service Section */}
          <h1 className="text-4xl sm:text-5xl font-semibold text-[#0c878c] mb-8 text-center">Terms of Service</h1>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">1. Use of Service</h2>
          <p className="mb-4 text-md leading-relaxed">
          ...
          <h1
            ...
            className="text-4xl sm:text-5xl font-semibold text-[#0c878c] mb-8 text-center mt-20"
          >
            Privacy Policy
          </h1>
          ...
          <h3 className="text-xl font-bold text-white mt-4 mb-2">Information You Provide Directly to Us:</h3>
          <ul className="list-disc list-inside mb-4 text-md leading-relaxed pl-4">
          ...
          <h3 className="text-xl font-bold text-white mt-4 mb-2">Information We Collect Automatically:</h3>
          <ul className="list-disc list-inside mb-4 text-md leading-relaxed pl-4">
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">3. Sharing Your Information</h2>
          <p className="mb-4 text-md leading-relaxed">
          ...
          <p className="mb-20 text-md leading-relaxed">
          <span className="font-bold">Disclaimer:</span> Please consult with a legal professional to draft terms specific to your business and jurisdiction.
          </p>
          <p className="text-md text-gray-400 text-center">Last Updated: June 3, 2025</p>
        </section>
