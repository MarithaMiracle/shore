...
const Listings = ({ searchCriteria, id }) => {
  ...
  if (loading) {
    return (
      ...
      <section id={id} className="bg-black py-20 px-6 lg:mt-[350px] mt-30 text-center text-gray-300">
  ...
  if (error) {
    return (
      ...
      <section id={id} className="bg-black py-20 px-6 lg:mt-[350px] mt-30 text-center text-red-500">
        <p>{error}</p>
      </section>
    );
  }
  ...
  return (
    ...
    <section id={id} className="bg-black py-20 px-6 mt-[550px] xs:mt-[550px] sm:mt-[550px] md:mt-[750px] lg:mt-[150px] xl:mt-[200px]">
