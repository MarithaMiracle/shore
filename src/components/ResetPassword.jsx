...
const ResetPassword = () => {
  ...
  useEffect(() => {
    ...
    // Uncomment and implement token verification here if needed
  }, [token]);
  ...
  return (
    ...
    >
      ...
      {/* Logo */}
      <div className="fixed lg:top-40 sm:top-65 xs:top-65 top-68 z-20 flex justify-center w-full">
        <img
      ...
      >
        ...
        <p className="text-center text-xs lg:text-sm text-gray-400">
          ...
          <Link to="/create-account" className="hover:underline" style={{ color: '#0c878c' }}>
            Create one
          </Link>
        </p>
      </div>
