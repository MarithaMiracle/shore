  ...
  return (
    ...
    >
      <div className="z-20 flex flex-col items-center justify-center text-center px-4 mt-[-15vh]">
        <h1
          className={`font-bold mb-2 text-[#4a5568] text-4xl md:text-6xl lg:text-7xl ${
            imageError ? 'text-[#0c878c]' : ''
          }`}
        ...
        <p
          className={`text-[#718096] text-base md:text-xl max-w-[80%] leading-relaxed mb-8 ${
            imageError ? 'text-[#a0aec0]' : ''
          }`}
        >
